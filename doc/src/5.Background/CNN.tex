...
The second section is concentrated on the training of a \acrshort{cnn}. We explain briefly the backpropagation algorithm, which consists of a forward-propagation (section \ref{subs:trainforward}) and a back-ropagation (section \ref{subs:trainbackward}).
